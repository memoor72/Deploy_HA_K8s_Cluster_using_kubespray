Vagrant.configure("2") do |config|
  ...
  nodes = [
    { :hostname => 'kube-master1', :ip => '192.168.50.11', :ram => 2048, :cpu => 2 },
    { :hostname => 'kube-master2', :ip => '192.168.50.12', :ram => 2048, :cpu => 2 },
    { :hostname => 'kube-master3', :ip => '192.168.50.13', :ram => 2048, :cpu => 2 },
    ...
    { :hostname => 'kube-Mongodb', :ip => '192.168.50.17', :ram => 2048, :cpu => 2 },
    { :hostname => 'kube-nfs', :ip => '192.168.50.18', :ram => 2048, :cpu => 2 },
  ]
